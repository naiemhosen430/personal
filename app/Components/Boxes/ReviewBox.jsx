  ...
  return (
    <div data-aos="fade-right">
      <Swiper
        ...
        onSwiper={(swiper) => {}}
      >
        <SwiperSlide className="rounded-xl p-10 shadow-2xl cursor-pointer bg-slate-200 text-center">
          <img
            className="w-20 h-20 inline-block rounded-full m-10"
          ...
          <p className="text-slate-800 py-2">
            ...
            asperiores quis, laudantium quaerat facere deserunt veritatis quos?
            Libero enim aut itaque nihil officiis architecto minus optio ipsa
            modi, voluptates dicta?.
          </p>
          <Link
            href="/"
